...
INSERT INTO `alat` (`id`, `nama`, `jenis`, `kategori`) VALUES
(12, 'Stestokop', 'Medis', 'Medis'),
(13, 'Plester', 'Medis', 'Ringan');
...
INSERT INTO `data_obat` (`id`, `nama`, `kategori`, `tgl_exp`, `stok`, `jenis`) VALUES
(1, 'Tipes X1 x', 'Tipes', '2023-07-13', NULL, 'Minuman'),
(2, 'Tipes X2', 'Tipes', '2023-07-22', '20', 'Makanan'),
(3, 'a', 'a', '2023-07-10', '1', '1'),
(4, 'b', 'b', '2023-07-19', '1', '1'),
(5, 'c', 'c', '2023-07-03', '1', '2'),
(6, 'c', 'c', '2023-07-03', '1', '2'),
(7, 'd', 'd', '2023-07-21', '1', '1'),
(8, '1', '1', '0001-01-01', '1', '1'),
(9, '2', '3', '0003-03-03', '3', '3'),
(10, '1', '2', '0003-03-03', '3', '4'),
(11, '1', '2', '2023-07-13', '2', '3'),
(12, '2', '3', '2023-07-10', '1', '2'),
(13, '1', '2', '2023-07-13', '2', '2');
...
CREATE TABLE `rekam_medis` (
  ...
  `total_tarif` varchar(45) DEFAULT NULL,
...
ALTER TABLE `layanan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_layanan_jadwal_dokter1_idx` (`jadwal_dokter_id`);
...
--
ALTER TABLE `layanan`
  ADD CONSTRAINT `fk_layanan_jadwal_dokter1` FOREIGN KEY (`jadwal_dokter_id`) REFERENCES `jadwal_dokter` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
