...
function sendWa(nama,dokter,telp,tanggal,jam) {
  var message = 'Selamat Pagi/Siang/Sore/Malam, Bapak/Ibu '+ nama + ', Meningatkan Janji Temu Dengan Dokter '+ dokter + '. Pada Tanggal ' + tanggal + ' Di Jam '+ jam + '. Terima Kasih'
  message = encodeURIComponent(message);
  const whatsappLink = `https://wa.me/${telp}?text=${message}`;
