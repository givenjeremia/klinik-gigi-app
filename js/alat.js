...
$("#submit_add").on("click", function (e) {
  e.preventDefault();
  var form = document.querySelector("#FormTambahAlat");
  var form_data = new FormData(form);
  var url = "../../backend/alat/insert.php";
  $.ajax({
    type: "POST",
    url: url,
    data: form_data,
...
function updateData(id) {
  var url = "../../backend/alat/get_data_by_id.php";
  $.ajax(url, {
    type: "post",
    data: {
      id: id,
...
$("#submit_edit").on("click", function (e) {
  ...
  e.preventDefault();
  var form = document.querySelector("#FormEditAlat");
  var form_data = new FormData(form);
  form_data.append('id', id);
  var url = "../../backend/alat/update.php";
  $.ajax({
    type: "POST",
    url: url,
    data: form_data,
