...
try {
    ...
    $sql = "SELECT rk.id as IdReservasi, rk.no_antrian as NomorAntrian , rk.status_kehadiran as StatusKehadiran , dd.nama AS NamaDokter, dp.nama AS NamaPasien, rk.jam_reservasi AS Jam, rk.tanggal_reservasi AS Tanggal, rk.status as Status
