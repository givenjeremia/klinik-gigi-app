...
try {
    if ($_SESSION['auth']['role'] == 'dokter') {
        ...
        $sql = "SELECT rk.id as IdReservasi, rk.no_antrian as NoAntrian, rk.jam_reservasi AS Jam, rk.tanggal_reservasi as Tanggal, dp.nama as NamaPasien, dp.id As IdPasien, jd.id as IdJadwal
