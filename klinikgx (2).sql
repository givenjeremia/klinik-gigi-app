...
--
-- Host: localhost:8889
-- Generation Time: Dec 03, 2023 at 03:31 PM
...
--
-- Table structure for table `action_odontogram`
--

CREATE TABLE `action_odontogram` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `action_odontogram`
--

INSERT INTO `action_odontogram` (`id`, `key_data`, `nama`, `format`) VALUES
(1, '1', 'Sisa Akar', 'sts'),
(2, '2', 'Gigi Hilang', 'sts'),
(3, '3', 'Jembatan', 'sts'),
...
CREATE TABLE `new_odontogram` (
  ...
  `action_odontogram_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `new_odontogram` (`id`, `nomor_gigi`, `posisi`, `tanggal`, `rekam_medis_id`, `action_odontogram_id`) VALUES
(1, 17, 'center', '2023-12-03', 1, 12),
(2, 24, 'center', '2023-12-03', 1, 9),
(3, 21, 'top', '2023-12-03', 1, 3),
(4, 22, 'bottom', '2023-12-03', 1, 5),
(5, 65, 'center', '2023-12-03', 1, 3),
(6, 52, 'top', '2023-12-03', 1, 2),
(7, 75, 'center', '2023-12-03', 1, 1),
(8, 83, 'top', '2023-12-03', 1, 9),
(9, 72, 'top', '2023-12-03', 1, 13),
(10, 22, 'top', '2023-12-03', 1, 12),
(11, 22, 'bottom', '2023-12-03', 1, 2),
(12, 55, 'center', '2023-12-03', 1, 12),
(13, 55, 'right', '2023-12-03', 1, 9);
...
(15, NULL, NULL, NULL, NULL, NULL, 19, 'pending');
...
(41, '21', 'C', '2023-12-01', 'Tambalan', 'green', 19, 2),
(42, '61', 'C', '2023-12-03', 'Caries', 'yellow', 0, 0),
(43, '21', 'D', '2023-12-03', 'Tambalan', 'green', 19, 2),
(44, '22', 'C', '2023-12-03', 'Brecket', 'red', 19, 2);
...
(19, 'dsdq', '21312', NULL, NULL, 630000, '2023-11-28', NULL, 34, 5, NULL);
...
(19, 1, '2023-10-02 09:10:10', '2023-10-09', '13:00:00', 'approved', 3, NULL, 2, 'pending'),
...
(33, 1, '2023-11-26 07:40:23', '2023-11-26', '15:00:00', 'approved', 18, NULL, 2, 'hadir'),
(34, 1, '2023-11-28 12:35:01', '2023-11-28', '10:00:00', 'approved', 5, NULL, 2, 'hadir'),
(35, 1, '2023-12-03 08:06:54', '2023-12-03', '15:00:00', 'approved', 18, NULL, 2, 'hadir');
...
--
-- Indexes for table `action_odontogram`
--
ALTER TABLE `action_odontogram`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `action_odontogram`
--
ALTER TABLE `action_odontogram`
